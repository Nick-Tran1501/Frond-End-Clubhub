  ...
  return (
    <div className='galleryContainer'>
      <div className='gallery'>
        ...
        {/* Skewed card */}
        <section data-aos="zoom-in" className='galleryContent_1'>
        ...
        <section className='galleryContent_2'>
          <div className="splitview skewed">
            <div data-aos="fade-left" className="panel left">
                <div className="content">
        ...
        <section className='galleryContent_3'>
          <div className="splitview skewed">
            <div data-aos="fade-right" className="panel right">
                <div className="content">
            ...
            <div data-aos="fade-left" className="panel right_2">
                <div className="content">
                    <img src={club_2} alt="Duotone" />
                </div>
            </div>
